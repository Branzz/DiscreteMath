...
public class NumberToText { // TODO Util class??? belongs elsewhere?

//	private static HashMap<Integer, String> numberWords;
	private static String[] onesPlaceNumberNames = {
			"", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine" };
	private static String[] teensNumberNames = {
			"ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen" };
	private static String[] tensPlaceNumberNames = {
			"", "ten", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty", "ninety" };
	private static String[] placeNumberNames = {
			"hundred", "thousand", "million", "billion", "trillion", "quadrillion", "quintillion",
			"sextillion", "septillion", "octillion", "nonillion", "decillion"};
	private static String[] onesPlaceOrdinalNumberNames = {
			"", "first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eigth", "nineth" };
	private static String[] teensOrdinalNumberNames = {
			"tenth", "eleventh", "twelfth", "thirteenth", "fourteenth", "fifteenth", "sixteenth", "seventeenth", "eighteenth", "nineteenth" };
	private static String[] tensOrdinalOrdinalPlaceNumberNames = {
			"", "tenth", "twentieth", "thirtieth", "fourtieth", "fiftieth", "sixtieth", "seventieth", "eightieth", "ninetieth" };
	private static String[] placeOrdinalNumberNames = {
	...
	private static String[] onesPlaceFractionalNumberNames = {
			"whole", "half", "quarter"};
	static {
//		for (int i = 0; i < onesPlaceNumberNames.length; i++)
//			numberWords.put(i, onesPlaceNumberNames[i]);
	}
...
//				str.append(onesPlaceNumberNames[1]); // one
	...
	// public static String numberToString(BigInteger num) {
	//
	// }
	//
	//
	// public static String numberToString(NumberLiteral num) {
	// 	return numberToStringFractional(num.doubleValue());
	//
	// }
