...
public record AssociativityPrecedenceLevel(int precedence, Associativity associativity) {
	...
	static {
		Associativity[] associativities = new Associativity[] {
				RIGHT_TO_LEFT, LEFT_TO_RIGHT, LEFT_TO_RIGHT, LEFT_TO_RIGHT, LEFT_TO_RIGHT,
				LEFT_TO_RIGHT, LEFT_TO_RIGHT, LEFT_TO_RIGHT, LEFT_TO_RIGHT, LEFT_TO_RIGHT,
				LEFT_TO_RIGHT, LEFT_TO_RIGHT, RIGHT_TO_LEFT, LEFT_TO_RIGHT, LEFT_TO_RIGHT,
		};
		for (int i = 0; i < associativities.length; i++) {
			LEVELS[i] = new AssociativityPrecedenceLevel(i, associativities[i]);
		}
	}
