...
public class SimpleRegexToken<T> implements Token {
	...
	public SimpleRegexToken(@RegExp String regex, Set<Token> children) {
		this.matcher = Pattern.compile(regex).matcher("");
		this.children = children;
	}

	public SimpleRegexToken(Class<T> representingClass, String[] symbols) {
		this.representingClass = representingClass;
		this.symbols = Set.of(symbols);
	}

	public SimpleRegexToken(Set<Token> children) {
		this.children = children;
	}

	public SimpleRegexToken(Class<T> representingClass, Token... children) {
		this.representingClass = representingClass;
		this.children = Arrays.stream(children).collect(Collectors.toSet());
	}

	public SimpleRegexToken(@RegExp String regex) {
